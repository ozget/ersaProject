...
namespace ErsaProject.Persistence.Services
{
    public class UserService : IUserService
    {
        ...
        {
            var userRoles = await GetRolesToUserAsync(name);// name karşılık roller buluyor

            if (!userRoles.Any())
                return false;

            //endpoint ile kullanıcı rolleri arasında uyum varsa true olur
